        ...
        <div class="w-full bg-neutral rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('auth') }}">
                    ...
                    <button type="submit"
                        class="w-full text-dark font-bold bg-neutral-500 hover:bg-warning focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg text-sm px-5 py-2.5 text-center">Masuk</button>
                </form>
            </div>
        </div>
    </div>
